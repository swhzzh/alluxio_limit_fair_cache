...
public class DefaultBlockWorkerClient implements BlockWorkerClient {
  ...
  @Override
  public GenerateUserSpaceReportResponse generateUserSpaceReport(
      GenerateUserSpaceReportRequest reportRequest) {
    return mRpcBlockingStub.generateUserSpaceReport(reportRequest);
  }
