...
public interface BlockWorker extends Worker, SessionCleanable {
  ...
  void abortUserBlock(long sessionId, long blockId) throws BlockAlreadyExistsException,
      BlockDoesNotExistException, InvalidWorkerStateException, IOException;
  ...
  void accessUserBlock(long sessionId, long userId, long blockId) throws BlockDoesNotExistException;
  ...
  void commitUserBlock(long sessionId, long blockId, boolean pinOnCreate)
      throws BlockAlreadyExistsException, BlockDoesNotExistException, InvalidWorkerStateException,
      IOException, WorkerOutOfSpaceException;
  /**
  ...
  String createUserBlock(long sessionId, long userId, long blockId, String tierAlias, String medium, long initialBytes)
    throws BlockAlreadyExistsException, WorkerOutOfSpaceException, IOException;
  ...
  void createUserBlockRemote(long sessionId, long userId, long blockId, String tierAlias,
      String medium, long initialBytes)
    throws BlockAlreadyExistsException, WorkerOutOfSpaceException, IOException;
  ...
  void freeUserSpace(long sessionId, long userId, long availableBytes, String tierAlias)
      throws WorkerOutOfSpaceException, BlockDoesNotExistException, IOException,
      BlockAlreadyExistsException, InvalidWorkerStateException;
  ...
  BlockMeta getUserVolatileBlockMeta(long userId, long blockId) throws BlockDoesNotExistException;
  ...
  BlockMeta getUserBlockMeta(long sessionId, long userId, long blockId, long lockId)
      throws BlockDoesNotExistException, InvalidWorkerStateException;
  ...
  boolean hasUserBlockMeta(long userId, long blockId);
  /**
  ...
  long lockUserBlock(long sessionId, long userId, long blockId) throws BlockDoesNotExistException;
  ...
  long lockUserBlockNoException(long sessionId, long userId, long blockId);
  ...
  void moveUserBlock(long sessionId, long userId, long blockId, String tierAlias)
      throws BlockDoesNotExistException, BlockAlreadyExistsException, InvalidWorkerStateException,
      WorkerOutOfSpaceException, IOException;
  /**
  ...
  void moveBlockToMedium(long sessionId, long blockId, String mediumType)
      throws BlockDoesNotExistException, BlockAlreadyExistsException, InvalidWorkerStateException,
      WorkerOutOfSpaceException, IOException;
  void moveUserBlockToMedium(long sessionId, long userId, long blockId, String mediumType)
      throws BlockDoesNotExistException, BlockAlreadyExistsException, InvalidWorkerStateException,
      WorkerOutOfSpaceException, IOException;

  void readSharedBlock(long sessionId, long userId, long blockId, long lockId)
      throws BlockDoesNotExistException, InvalidWorkerStateException, WorkerOutOfSpaceException,
      BlockAlreadyExistsException, UserOutOfSpaceException;
  ...
  String readBlock(long sessionId, long blockId, long lockId)
      throws BlockDoesNotExistException, InvalidWorkerStateException;
  String readUserBlock(long sessionId, long userId, long blockId, long lockId)
      throws BlockDoesNotExistException, InvalidWorkerStateException, UserOutOfSpaceException;
  /**
  ...
  BlockReader readUserBlockRemote(long sessionId, long userId, long blockId, long lockId)
      throws BlockDoesNotExistException, InvalidWorkerStateException, IOException,
      WorkerOutOfSpaceException, UserOutOfSpaceException, BlockAlreadyExistsException;
  /**
  ...
  BlockReader readUserUfsBlock(long sessionId, long userId, long blockId, long offset)
      throws BlockDoesNotExistException, IOException;
  /**
  ...
  void removeUserBlock(long sessionId, long userId, long blockId)
      throws InvalidWorkerStateException, BlockDoesNotExistException, IOException;
  /**
  ...
  void requestUserSpace(long sessionId, long userId, long blockId, long additionalBytes)
      throws BlockDoesNotExistException, WorkerOutOfSpaceException, IOException;
  ...
  void unlockUserBlock(long lockId) throws BlockDoesNotExistException;
  ...
  boolean unlockUserBlock(long sessionId, long blockId);
  ...
  void updatePinList(Map<Long, Set<Long>> userIdToPinnedInodes);
  ...
  boolean openUserUfsBlock(long sessionId, long userId, long blockId, Protocol.OpenUfsBlockOptions options)
      throws BlockAlreadyExistsException;
  /**
  ...
  void closeUserUfsBlock(long sessionId, long userId, long blockId)
      throws BlockAlreadyExistsException, BlockDoesNotExistException, IOException,
      WorkerOutOfSpaceException;

  void cleanupSessionAndUser(long sessionId);
}
