...
public interface BlockStoreEventListener {
  ...
  void onUserAccessBlock(long sessionId, long userId, long blockId);
  /**
  ...
  void onUserAbortBlock(long sessionId, long userId, long blockId);
  ...
  void onUserCommitBlock(long sessionId, long userId, long blockId, BlockStoreLocation location);
  ...
  void onUserMoveBlockByClient(long sessionId, long userId, long blockId, BlockStoreLocation oldLocation,
      BlockStoreLocation newLocation);
  ...
  void onUserMoveBlockByWorker(long sessionId, long userId, long blockId, BlockStoreLocation oldLocation,
      BlockStoreLocation newLocation);
  ...
  void onUserRemoveBlockByClient(long sessionId, long userId, long blockId);
  ...
  void onUserRemoveBlockByWorker(long sessionId, long userId, long blockId);
  /**
  ...
  void onUserBlockLost(long userId, long blockId);
  /**
