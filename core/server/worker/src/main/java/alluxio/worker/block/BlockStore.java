...
public interface BlockStore extends SessionCleanable {
  ...
  TempBlockMeta createUserBlock(long sessionId, long userId, long blockId, BlockStoreLocation location,
      long initialBlockSize) throws BlockAlreadyExistsException, WorkerOutOfSpaceException, IOException;

  void readSharedBlock(BlockMeta blockMeta, long userId)
  ...
  void requestUserSpace(long sessionId, long blockId, long additionalBytes)
      throws BlockDoesNotExistException, WorkerOutOfSpaceException, IOException;
  /**
  ...
  BlockReader getUserBlockReader(long sessionId, long userId, long blockId, long lockId)
  ...
  void moveUserBlock(long sessionId, long userId, long blockId, BlockStoreLocation newLocation)
    throws BlockDoesNotExistException, BlockAlreadyExistsException, InvalidWorkerStateException,
      WorkerOutOfSpaceException, IOException;
  ...
  void moveBlock(long sessionId, long blockId, BlockStoreLocation oldLocation,
      ...
      IOException;
  void moveUserBlock(long sessionId, long userId, long blockId, BlockStoreLocation oldLocation,
      BlockStoreLocation newLocation) throws BlockDoesNotExistException,
      BlockAlreadyExistsException, InvalidWorkerStateException, WorkerOutOfSpaceException,
      IOException;
  /**
  ...
  void removeUserBlock(long sessionId, long userId, long blockId) throws InvalidWorkerStateException,
      BlockDoesNotExistException, IOException;
  ...
  void removeUserBlock(long sessionId, long userId, long blockId, BlockStoreLocation location)
      throws InvalidWorkerStateException, BlockDoesNotExistException, IOException;
  /**
  ...
  void freeUserSpace(long sessionId, long userId, long availableBytes, BlockStoreLocation location)
      throws WorkerOutOfSpaceException, BlockDoesNotExistException, IOException;
  ...
  void updateUserPinnedInodes(Map<Long, Set<Long>> newUserIdToPinnedInodesMap);
  /**
